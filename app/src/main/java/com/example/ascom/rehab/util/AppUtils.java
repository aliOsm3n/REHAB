...
public class AppUtils {
    ...
    public static void applyLightFont(TextView... views) {
        for (TextView textView :
                views) {
            textView.setTypeface(Typeface.createFromAsset(textView.getContext().getAssets(), "fonts/GE_SS_Two_Light.otf"));
        }
    }
    ...
    public static void applyMediumFont(TextView... views) {
        for (TextView textView :
                views) {
            textView.setTypeface(Typeface.createFromAsset(textView.getContext().getAssets(), "fonts/GE_SS_Two_Medium.otf"));
        }
    }
    ...
    public static void applyBoldFont(TextView... views) {
        for (TextView textView :
                views) {
            textView.setTypeface(Typeface.createFromAsset(textView.getContext().getAssets(), "fonts/GE_SS_Two_Bold.otf"));
        }
    }
